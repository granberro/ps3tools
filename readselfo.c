...
*/
	printf("    file                          file                         "
	       "file                file                file                file\n");
	printf("    offset     offset             offset     size              "
	       "offset  compressed  offset     unk1     offset     unk2     offset  encrypted\n");
...
*/
		printf("    %08x = %08x_%08x  %08x = %08x_%08x %08x = %s    %08x = %08x %08x = %08x %08x = %s\n",
				(u32)(sec_offset + i*0x20 + 0x00),		/* 0x00 added */
				(u32)(offset >> 32), (u32)offset,		/* 0x00 */
				(u32)(sec_offset + i*0x20 + 0x08),		/* 0x08 added */
				(u32)(size >> 32), (u32)size,			/* 0x08 */
				(u32)(sec_offset + i*0x20 + 0x10),		/* 0x10 added */
				id2name(compressed, t_compressed, "[???]"),	/* 0x10 */
				(u32)(sec_offset + i*0x20 + 0x14),		/* 0x14 added */
				unk1,						/* 0x14 */
				(u32)(sec_offset + i*0x20 + 0x18),		/* 0x18 added */
				unk2,						/* 0x18 */
				(u32)(sec_offset + i*0x20 + 0x1c),		/* 0x1c added */
				id2name(encrypted, t_encrypted, "[???]")	/* 0x1c */
				);
	}
